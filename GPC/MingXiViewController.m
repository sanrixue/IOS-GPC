...
- (void)viewDidLoad {
    ...
    //注册表格单元
    [self.tableView registerClass:[DetailCell class] forCellReuseIdentifier:detailIndentifier];
...
-(void)loadNewData
{
    ...
    NSString * url = [NSString stringWithFormat:Main_URL,Mingxi_URL];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    DetailModel *detailModel = [DetailModel detailWithDict:dic];
    
    
    
    DetailCell *cell = [tableView dequeueReusableCellWithIdentifier:detailIndentifier];
