...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"信用积分历史记录";
...
//    self.tableView.scrollEnabled = NO;
    ...
    //注册表格单元
    [self.tableView registerClass:[HistoryCell class] forCellReuseIdentifier:historyIndentifier];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HistoryModel *historyModel = [HistoryModel historyWithDict:dic];
    
    HistoryCell *cell = [tableView dequeueReusableCellWithIdentifier:historyIndentifier];
